...
namespace flash {
  ...
  FBLAS_INT kmeans(CHAR mat_ord, CHAR trans_a, CHAR trans_b, FBLAS_UINT m,
    ...
    vec3<KMeansTask *> tasks(
        NUM_B[1], vec2<KMeansTask *>(NUM_B[0], vector<KMeansTask *>(NUM_B[2])));
